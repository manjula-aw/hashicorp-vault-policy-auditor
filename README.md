...
**1. Prepare Test Data**
Create a new folder named `test_policies` and populate it with the following files:
...
* **New:** Ensure `advanced_syntax_plus.hcl` is flagged as **MEDIUM** for "Uses Segment Wildcard (+)".
